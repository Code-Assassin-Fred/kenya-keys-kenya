        ...
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
                    {methods.map((method, idx) => (
                        <motion.div
                            ...
                            className="group flex flex-col p-6 sm:p-10 rounded-3xl sm:rounded-[40px] bg-white border border-gray-100 shadow-sm hover:shadow-2xl hover:border-blue-100 transition-all duration-500"
                        >
                ...
                <motion.div 
                    ...
                    className="mt-24 p-6 sm:p-12 bg-[#F0F7FF] rounded-3xl sm:rounded-[40px] border-2 border-blue-100 flex flex-col md:flex-row items-center gap-12"
                >
