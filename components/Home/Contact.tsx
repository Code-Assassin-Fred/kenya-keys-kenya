                    ...
                    <div className="flex justify-between items-start mb-12">
                        <div className="space-y-5">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span className="font-bold text-gray-800 font-outfit">infokenya@kenyakeyspbo-kenya.org</span>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span className="font-bold text-gray-800 font-outfit">info@kenyakeyspbo-kenya.org</span>
                            </div>
                        </div>
