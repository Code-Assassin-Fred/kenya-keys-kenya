                    ...
                    <div className="flex justify-between items-start mb-12">
                        <div className="space-y-5">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <a href="mailto:info@kenyakeys-pbokenya.org" className="font-bold text-gray-800 font-outfit hover:text-[#1D366D] transition-colors">info@kenyakeys-pbokenya.org</a>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <a href="mailto:joseph@kenyakeys-pbokenya.org" className="font-bold text-gray-800 font-outfit hover:text-[#1D366D] transition-colors">joseph@kenyakeys-pbokenya.org</a>
                            </div>
                        </div>

                        {/* Social Icons */}
                        <div className="flex gap-4">
                            <a href="https://www.facebook.com/profile.php?id=61590875852245" target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-100 rounded-full hover:bg-gray-50 transition-all text-[#1D366D]" aria-label="Facebook">
                            ...
                            <a href="https://www.instagram.com/kenyakeyspbo_kenya/" target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-100 rounded-full hover:bg-gray-50 transition-all text-[#1D366D]" aria-label="Instagram">
                            ...
                            <a href="https://x.com/KenyaKeys_Kenya" target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-100 rounded-full hover:bg-gray-50 transition-all text-[#1D366D]" aria-label="X (Twitter)">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                            </a>
                            <a href="https://wa.me/254724783436" target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-100 rounded-full hover:bg-gray-50 transition-all text-[#1D366D]" aria-label="WhatsApp">
