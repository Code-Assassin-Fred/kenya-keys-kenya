                ...
                <div className="flex-1 flex flex-col pt-0">
                    ...
                    <div className="flex justify-between items-start mb-12">
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.facebook.com/profile.php?id=61592515594553" target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-100 rounded-full hover:bg-gray-50 transition-all text-[#1D366D]" aria-label="Facebook">
                            ...
                            <a href="https://www.instagram.com/kenyakeys_pbo/" target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-100 rounded-full hover:bg-gray-50 transition-all text-[#1D366D]" aria-label="Instagram">
                            ...
                            <a href="https://x.com/KenyaKeys_PBO" target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-100 rounded-full hover:bg-gray-50 transition-all text-[#1D366D]" aria-label="X (Twitter)">
