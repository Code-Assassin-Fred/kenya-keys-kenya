                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mt-6">
                            <a href="https://www.facebook.com/profile.php?id=61592515594553" target="_blank" rel="noopener noreferrer" className="p-2 border border-white/10 rounded-full hover:bg-white/10 transition-all text-white hover:text-[#C5E672]" aria-label="Facebook">
                            ...
                            <a href="https://www.instagram.com/kenyakeyspbo/" target="_blank" rel="noopener noreferrer" className="p-2 border border-white/10 rounded-full hover:bg-white/10 transition-all text-white hover:text-[#C5E672]" aria-label="Instagram">
                            ...
                            <a href="https://x.com/KenyaKeys_PBO" target="_blank" rel="noopener noreferrer" className="p-2 border border-white/10 rounded-full hover:bg-white/10 transition-all text-white hover:text-[#C5E672]" aria-label="X (Twitter)">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                            </a>
                            <a href="https://wa.me/254724873436" target="_blank" rel="noopener noreferrer" className="p-2 border border-white/10 rounded-full hover:bg-white/10 transition-all text-white hover:text-[#C5E672]" aria-label="WhatsApp">
                    ...
                    <div>
                        ...
                        <div className="space-y-6 font-outfit">
                            ...
                            <div>
                                ...
                                <a href="tel:+254724873436" className="text-gray-300 hover:text-white transition-colors block">+254 724873436</a>
                                <a href="https://wa.me/254724873436" target="_blank" rel="noopener noreferrer" className="text-[#C5E672] hover:text-[#b4d45d] text-sm font-semibold transition-colors flex items-center gap-1.5 mt-1">
