                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mt-6">
                            ...
                            <a href="https://www.instagram.com/kenyakeys_pbo/" target="_blank" rel="noopener noreferrer" className="p-2 border border-white/10 rounded-full hover:bg-white/10 transition-all text-white hover:text-[#C5E672]" aria-label="Instagram">
